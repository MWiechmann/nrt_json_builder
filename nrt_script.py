...
class BaseParams(tk.Frame):
    def __init__(self,master=None,**kw):
        ...
        tk.Button(self,text="Ok",command = self.adjust_base_params).grid(row=row_nr+1,column=1)
...
class ChoosePerm(tk.Frame):
    def __init__(self,master=None,**kw):
        ...
        tk.Button(self,text="OK",command = self.get_picks_vals).grid(row=row_nr,column=1)
...
class SetPermParams(tk.Frame):
    def __init__(self,master=None,**kw):
        ...
        tk.Button(self,text="Ok",command = self.adjust_perm_params).grid(row=row_nr+1,column=1)
